...
// 6.1 Phân tích body (form & JSON)
app.use(express.urlencoded({ extended: true }));
app.use(express.json());

// 6.2 Session (phải trước CSRF)
await sessionConfig(app);

// 6.3 Gắn session vào mọi view (tùy chọn, giúp EJS dùng session dễ dàng)
app.use((req, res, next) => {
  res.locals.session = req.session;
  next();
});

// 6.4 CSRF protection (POST/PUT/DELETE)
...
// 7.1 Cấu hình passport Google Auth 2.0
passportConfig(app);
...
// =======================
// 10. Khởi động server HTTPS localhost
// =======================
...
// =======================
// 11. Khởi động server HTTP deploy Render
// =======================
app.listen(PORT, () => {
